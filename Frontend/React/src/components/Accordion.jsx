...
export default function Accordion() {
  return (
    <div className="accordion">
      <QuestionCard question='Ordering for Delivery?'
      ...
      <QuestionCard question='Potting Services'
      ...
      <QuestionCard question='Do we Ship Plants?'
      ...
      <QuestionCard question='Ordering for Pick up?'
