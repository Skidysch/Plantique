  ...
  return (
    <div className="purpose">
      <div className="purpose__header">
        ...
        <p className="purpose__text">We want our Visitors to be inspire to get their hands dirty</p>
      </div>
      <Video width={244}
             height={142}
             poster={Poster}
      ...
      <div className="purpose__description">
        <p>
          Each plant is cared <img className="purpose__image" src={healthyIcon}/> for by our
          <br/>horticultural experts, so they are as
          <br/>happy as healthy as they get.
        </p>
      </div>
    </div>
  )
